...
package com.iflytek.cyber.iot.show.core.impl.SpeechSynthesizer
...
class SpeechSynthesizerHandler(mediaPlayer: MediaPlayer, speaker: Speaker) : SpeechSynthesizer(mediaPlayer, speaker) {
