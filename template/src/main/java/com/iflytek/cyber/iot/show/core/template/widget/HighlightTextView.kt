...
package com.iflytek.cyber.iot.show.core.template.widget
...
@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    companion object {
        ...
        private const val ALPHA_COVER = 128
    }
    ...
    fun startAnimation() {
        ...
        Log.d(sTag, "text: $text, array: ${timestampArray.toArray()?.contentToString()}")
    }
